...
import { Search, Info, RefreshCw, MapPin, Activity, Clock } from "lucide-react"
        ...
        {airData ? (
          <>
            <div className="bg-gray-800 rounded-xl shadow-xl p-6 mb-6 transform transition-all hover:shadow-2xl">
              ...
              <div className="border-t border-b border-gray-700 py-6 mb-6 backdrop-blur-sm bg-gray-700/30 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <h2 className="text-lg font-semibold text-gray-300">Air Quality Index</h2>
                    ...
                    <p className="text-lg font-medium" style={{ color: getAQIColor(airData.aqi) }}>
                      Air Quality is {getAQIDescription(airData.aqi)}
                    </p>
                  </div>
                </div>
              ...
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-gray-300 mb-3">Major Air Pollutants</h2>
                <div className="bg-gray-700/50 rounded-lg p-4 mb-3 backdrop-blur-sm">
                  <h3 className="font-medium text-white">{location?.name || "Current Location"}</h3>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { name: 'Particulate Matter (PM2.5)', value: airData.pm25, unit: 'µg/m³', key: 'pm25' },
                    { name: 'Sulfur Dioxide (SO2)', value: airData.so2, unit: 'ppb', key: 'so2' },
                    { name: 'Particulate Matter (PM10)', value: airData.pm10, unit: 'µg/m³', key: 'pm10' },
                    { name: 'Nitrogen Dioxide (NO2)', value: airData.no2, unit: 'ppb', key: 'no2' },
                    { name: 'Carbon Monoxide (CO)', value: airData.co, unit: 'ppb', key: 'co' },
                    { name: 'Ozone (O3)', value: airData.o3, unit: 'ppb', key: 'o3' }
                  ].map((pollutant) => (
                    <div 
                      key={pollutant.key}
                      className="bg-gray-700/50 rounded-lg p-4 backdrop-blur-sm transform transition-all hover:scale-[1.02] hover:shadow-lg"
                    >
                      <h3 className="font-medium text-gray-300 mb-2">{pollutant.name}</h3>
                      <p 
